...
## 2. React 장점
-  빠른 엄데이트와 렌더링 속도 : React DOM
- 컴포넌트의 재상용성 : 함수기반의 컴포넌트 생성
...
- 상대 관리 복잡성 : React Hooks를 통한 상태 관리, 비동기식 처리

## 4. React 프로젝트 생성
- 리액트 사이드 : https://reactjs.org ---> https://react.dev
...
- 자식은 참조객체변수 혹은 구조분해할당 형식으로 데이터를 전달 받음
...
- src > components > commons : 최소의 컴포넌트
- src > components > shared ㅣ 최소 컴포넌트 + 비즈니스 로직 ..
